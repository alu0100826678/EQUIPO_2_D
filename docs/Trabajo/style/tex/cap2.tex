...
El teorema de Taylor da estimaciones cuantitativas sobre el error en la aproximación de una función. Cualquier número finito de términos iniciales de la serie de Taylor de una función se llama
...
\clearpage
\emph{}
\subsection{Aplicación Series de Taylor en f(x)=ln(x)}
